...
<!-- Tell the browser to be responsive to screen width -->
  ...
  <!-- DataTables CSS -->
    <link href="<?php echo base_url() ?>assets/vendor/datatables.net-bs4/css/dataTables.bootstrap4.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="<?php echo base_url() ?>assets/vendor/datatables.net-responsive-bs4/responsive.bootstrap4.css" rel="stylesheet">
</head>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo site_url('admin') ?>" class="nav-link">SD UNGGULAN AISYIYAH</a>
      </li>
    </ul>
