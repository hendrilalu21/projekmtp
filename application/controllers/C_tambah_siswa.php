...
class C_tambah_siswa extends CI_Controller {
	...
	public function tampilan_form_download(){
        $data['siswa'] = $this->m_semua_siswa->tampil_download();
		$this->load->view('admin/templates/header');
		$this->load->view('admin/templates/sidebar');
		$this->load->view('admin/form_download', $data);
		$this->load->view('admin/templates/footer');
    }
	...
	{
		$data = $this->db->get_where('catatan',['kode_pendaftaran'=>$id])->row();
		force_download('assets/akte/'.$data->akte_kelahiran,NULL);
	}
